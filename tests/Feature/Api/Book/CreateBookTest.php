...
describe('BookController -> store', function () {
    ...
    */
    describe('validation', function () {
        ...
        it('fails if the title, slug and description are too long', function () {
            $editor = User::factory()->editor()->create();
            Sanctum::actingAs($editor);
        ...
        it('fails if slug is taken by another book', function () {
    ...
    */
    describe('caching', function () {
        it('flushes cache if a book is created', function () {
            $editor = User::factory()->editor()->create();
            Sanctum::actingAs($editor);
