...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title',
...
'pagination.users_per_page','pagination.authors_per_page','pagination.books_per_page','permission.models.permission','permission.models.role',
...
'super-admin.password','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','data.date_format','data.date_timezone',
...
'data.commands.make.namespace','data.commands.make.suffix','data.livewire.enable_synths','query-builder.parameters.include','query-builder.parameters.filter',
...
'author.store','author.show','author.update','author.destroy','storage.local','storage.local.upload',);
