...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','pagination.users_per_page','pagination.authors_per_page',
...
'mcp.redirect_domains','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'data.livewire.enable_synths','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort','query-builder.parameters.fields',
...
'users.index','users.show','storage.local',
...
'VITE_APP_NAME','UID','GID','AUTH_GUARD','L5_SWAGGER_GENERATE_ALWAYS',
'L5_SWAGGER_CONST_HOST','L5_SWAGGER_USE_ABSOLUTE_PATH','SUPER_ADMIN_NAME','SUPER_ADMIN_EMAIL','SUPER_ADMIN_PASSWORD',
'USERS_PER_PAGE','AUTHORS_PER_PAGE','BOOKS_PER_PAGE',);
