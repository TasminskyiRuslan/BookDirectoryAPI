...
'boost.executable_paths.vendor_bin','mcp.redirect_domains','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'data.commands.make.suffix','data.livewire.enable_synths','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'sanctum.csrf-cookie','auth.register','auth.login','auth.me','auth.logout','storage.local','storage.local.upload',);
