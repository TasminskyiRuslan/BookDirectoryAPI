...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cache.ttl.authors' => 'string',
            'cache.ttl.books' => 'string',
            ...
            'filesystems.disks.authors.driver' => 'string',
            'filesystems.disks.authors.root' => 'string',
            'filesystems.disks.authors.url' => 'string',
            'filesystems.disks.authors.visibility' => 'string',
            'filesystems.disks.authors.throw' => 'boolean',
            'filesystems.disks.authors.report' => 'boolean',
            'filesystems.disks.books.driver' => 'string',
            'filesystems.disks.books.root' => 'string',
            'filesystems.disks.books.url' => 'string',
            'filesystems.disks.books.visibility' => 'string',
            ...
            'pagination.authors_per_page' => 'string',
            'pagination.books_per_page' => 'string',
...
'cache.ttl.authors','cache.ttl.books','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.authors.driver','filesystems.disks.authors.root','filesystems.disks.authors.url',
'filesystems.disks.authors.visibility','filesystems.disks.authors.throw','filesystems.disks.authors.report','filesystems.disks.books.driver','filesystems.disks.books.root',
'filesystems.disks.books.url','filesystems.disks.books.visibility','filesystems.disks.books.throw','filesystems.disks.books.report','filesystems.links./var/www/html/public/storage',
'l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path','l5-swagger.documentations.default.paths.swagger_ui_assets_path',
...
'l5-swagger.defaults.routes.group_options','l5-swagger.defaults.paths.docs','l5-swagger.defaults.paths.views','l5-swagger.defaults.paths.base','l5-swagger.defaults.paths.excludes',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','pagination.users_per_page','pagination.authors_per_page',
'pagination.books_per_page','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'session.partitioned','super-admin.name','super-admin.email','super-admin.password','boost.enabled',
...
'boost.executable_paths.current_directory','mcp.redirect_domains','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'data.commands.make.suffix','data.livewire.enable_synths','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort',
...
'user.index','user.show','user.destroy','user.role.update','author.index',
'author.store','author.show','author.update','author.destroy','book.index',
'book.store','book.show','book.update','book.destroy','storage.local','storage.local.upload',);
...
'REDIS_PASSWORD','REDIS_PORT','REDIS_CACHE_CONNECTION','MAIL_MAILER','MAIL_SCHEME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','UID','GID','AUTH_GUARD',
'L5_SWAGGER_GENERATE_ALWAYS','L5_SWAGGER_CONST_HOST','L5_SWAGGER_USE_ABSOLUTE_PATH','SUPER_ADMIN_NAME','SUPER_ADMIN_EMAIL',
'SUPER_ADMIN_PASSWORD','USERS_PER_PAGE','AUTHORS_PER_PAGE','BOOKS_PER_PAGE','AUTHOR_CACHE_TTL',
'BOOK_CACHE_TTL',);
